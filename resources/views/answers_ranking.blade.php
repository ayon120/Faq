...
<div class="container">
<h4>@lang('Adminhome.Answers')</h4>
<h5>@lang('Adminhome.Total_Answers') : {{$num=count($pages)}}</h5>
    <table id="CT" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        <thead>
            <tr>
                <th>@lang('Adminhome.ID')</th>
                <th>@lang('Adminhome.Question_ID')</th>
                <th>@lang('Adminhome.Answers')</th>
...
@if(count($pages)>0)
    ...
    @endforeach
@else
<p>@lang('Adminhome.No_Answers_Found')</p>
